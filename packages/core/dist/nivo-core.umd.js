(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/tooltip'), require('prop-types'), require('lodash/merge'), require('lodash/get'), require('lodash/set'), require('d3-interpolate'), require('react-spring'), require('lodash/isString'), require('lodash/last'), require('lodash/isArray'), require('d3-scale'), require('d3-scale-chromatic'), require('lodash/isFunction'), require('lodash/without'), require('d3-shape'), require('d3-hierarchy'), require('d3-format'), require('d3-time-format'), require('recompose/withProps'), require('lodash/isEqual'), require('recompose/compose'), require('recompose/setPropTypes'), require('recompose/defaultProps'), require('recompose/withPropsOnChange'), require('lodash/isPlainObject'), require('lodash/pick')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/tooltip', 'prop-types', 'lodash/merge', 'lodash/get', 'lodash/set', 'd3-interpolate', 'react-spring', 'lodash/isString', 'lodash/last', 'lodash/isArray', 'd3-scale', 'd3-scale-chromatic', 'lodash/isFunction', 'lodash/without', 'd3-shape', 'd3-hierarchy', 'd3-format', 'd3-time-format', 'recompose/withProps', 'lodash/isEqual', 'recompose/compose', 'recompose/setPropTypes', 'recompose/defaultProps', 'recompose/withPropsOnChange', 'lodash/isPlainObject', 'lodash/pick'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.PropTypes, global['lodash/merge'], global['lodash/get'], global['lodash/set'], global.d3, global['react-spring'], global['lodash/isString'], global['lodash/last'], global['lodash/isArray'], global.d3, global.d3, global['lodash/isFunction'], global['lodash/without'], global.d3, global.d3, global.d3, global.d3, global.RecomposeWithProps, global['lodash/isEqual'], global.RecomposeCompose, global.RecomposeSetPropTypes, global.RecomposeDefaultProps, global.RecomposeWithPropsOnChange, global['lodash/isPlainObject'], global['lodash/pick']));
}(this, (function (exports, React, tooltip, PropTypes, merge, get, set, d3Interpolate, reactSpring, _isString, last, isArray, d3Scale, d3ScaleChromatic, isFunction, without, d3Shape, d3Hierarchy, d3Format, d3TimeFormat, withProps, isEqual, compose, setPropTypes, defaultProps, withPropsOnChange, isPlainObject, pick) { 'use strict';
  ...
  var useAnimatedPath = function useAnimatedPath(path) {
    ...
    return reactSpring.to(value, interpolator);
  };
  ...
  var Container = function Container(_ref) {
    ...
    return React__default.createElement(ThemeProvider, {
      ...
      config: motionConfig
    }, React__default.createElement(tooltip.TooltipProvider, {
      container: container
    ...
    }, children, isInteractive && React__default.createElement(tooltip.Tooltip, null)))));
  };
  ...
  var LegacyContainer = function LegacyContainer(_ref) {
    ...
    return React__default.createElement(ThemeProvider, {
      ...
      damping: motionDamping,
      config: motionConfig
    }, React__default.createElement(tooltip.TooltipActionsContext.Provider, {
      value: tooltipActions
    }, React__default.createElement(tooltip.TooltipStateContext.Provider, {
      value: tooltipState
    }, React__default.createElement(ConditionalWrapper, {
      condition: renderWrapper,
      wrapper: React__default.createElement("div", {
    ...
    }, children(handlers), isInteractive && React__default.createElement(tooltip.Tooltip, null))))));
  };
