(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('@nivo/arcs'), require('@nivo/legends'), require('lodash/get'), require('d3-shape'), require('@nivo/colors'), require('@nivo/tooltip')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', '@nivo/arcs', '@nivo/legends', 'lodash/get', 'd3-shape', '@nivo/colors', '@nivo/tooltip'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.nivo, global.nivo, global['lodash/get'], global.d3, global.nivo, global.nivo));
}(this, (function (exports, React, core, arcs, legends, _get, d3Shape, colors, tooltip) { 'use strict';
  ...
  var InnerPie = function InnerPie(_ref) {
    var data = _ref.data,
        ...
        arcLabelComponent = _ref.arcLabelComponent,
