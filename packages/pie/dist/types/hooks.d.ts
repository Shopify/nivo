...
import { CompletePieSvgProps, ComputedDatum, PieCustomLayerProps } from './types';
 ...
 * expressed in pixels.
 */
export declare const usePie: <RawDatum>({ data, radius, innerRadius, startAngle, endAngle, padAngle, sortByValue, cornerRadius, activeInnerRadiusOffset, activeOuterRadiusOffset, }: Pick<CompletePieSvgProps<RawDatum>, "startAngle" | "endAngle" | "sortByValue" | "padAngle" | "cornerRadius" | "activeInnerRadiusOffset" | "activeOuterRadiusOffset"> & {
