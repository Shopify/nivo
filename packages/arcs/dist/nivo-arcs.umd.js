(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('@nivo/colors'), require('react-spring'), require('d3-shape')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', '@nivo/colors', 'react-spring', 'd3-shape'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.nivo, global['react-spring'], global.d3));
}(this, (function (exports, React, core, colors, reactSpring, d3Shape) { 'use strict';
  ...
  var interpolateArcCenter = function interpolateArcCenter(offset) {
    return function (startAngleValue, endAngleValue, innerRadiusValue, outerRadiusValue) {
      return reactSpring.to([startAngleValue, endAngleValue, innerRadiusValue, outerRadiusValue], function (startAngle, endAngle, innerRadius, outerRadius) {
  ...
  var useArcCentersTransition = function useArcCentersTransition(data) {
    ...
    var transition = reactSpring.useTransition(data, {
      key: function key(datum) {
        return datum.id;
      },
  ...
  var interpolateLink = function interpolateLink(startAngleValue, endAngleValue, innerRadiusValue, outerRadiusValue, offsetValue, diagonalLengthValue, straightLengthValue) {
    return reactSpring.to([startAngleValue, endAngleValue, innerRadiusValue, outerRadiusValue, offsetValue, diagonalLengthValue, straightLengthValue], function (startAngle, endAngle, innerRadius, outerRadius, offset, diagonalLengthAnimated, straightLengthAnimated) {
  ...
  var interpolateTextPosition = function interpolateTextPosition(startAngleValue, endAngleValue, innerRadiusValue, outerRadiusValue, offsetValue, diagonalLengthValue, straightLengthValue, textOffsetValue) {
    return reactSpring.to([startAngleValue, endAngleValue, innerRadiusValue, outerRadiusValue, offsetValue, diagonalLengthValue, straightLengthValue, textOffsetValue], function (startAngle, endAngle, innerRadius, outerRadius, offset, diagonalLengthAnimated, straightLengthAnimated, textOffset) {
  ...
  var useArcLinkLabelsTransition = function useArcLinkLabelsTransition(_ref2) {
    ...
    var transition = reactSpring.useTransition(filteredData, {
      key: function key(datum) {
        return datum.id;
      },
  ...
  var useAnimatedArc = function useAnimatedArc(datumWithArc, arcGenerator) {
    ...
    var animatedValues = reactSpring.useSpring({
  ...
  var useArcGenerator = function useArcGenerator(_ref) {
